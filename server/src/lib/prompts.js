...
DO NOT add any watermarks, brand names, logos, or decorative text.
DO NOT add extra layers unless they are clearly visible in the image.
DO NOT invent titles/legends/annotations. Keep only elements visible.
Use Vega-Lite v6 only.
...
PIE CHART TEXT RULES (only if the image is a pie/donut):
